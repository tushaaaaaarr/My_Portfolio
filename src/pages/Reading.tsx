...
import ittefaq from '../images/ittefaq.jpg';
...
const books = [
  ...
  },
  {
    ...
    author: "J.K. Rowling",
    imgSrc: hp,
    description: "An epic fantasy series that captivated millions with magic, friendship, and heroism.",
  },
  {
    title: "Ittefaq",
    author: "Keshav Upadhyay",
    imgSrc: ittefaq,
    description: "A captivating Hindi love story where fate brings two hearts together through emotional twists and unforgettable moments.",
  },
];
