...
6. Jarvis AI - Intelligent Chat Assistant for my Portfolio with React.js, FastAPI, and Groq LLMs
...
- Dont hallcinate information - only provide factual details based on Tushar's actual experience and skills
