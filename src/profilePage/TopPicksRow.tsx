...
import { FaMountain, FaCode, FaBriefcase, FaCertificate, FaHandsHelping, FaProjectDiagram, FaEnvelope, FaMusic, FaBook, FaTrophy } from 'react-icons/fa';
...
const topPicksConfig = {
  recruiter: [
    ...
    { title: "Awards", imgSrc: "https://picsum.photos/seed/awards/250/200", icon: <FaTrophy />, route: "/awards" },
    { title: "Certifications", imgSrc: "https://picsum.photos/seed/certifications/250/200", icon: <FaCertificate />, route: "/certifications" },
    { title: "Travel & Exploration", imgSrc: "https://picsum.photos/seed/travel/250/200", icon: <FaMountain />, route: "/travel" },
  ...
  developer: [
    ...
    { title: "Awards", imgSrc: "https://picsum.photos/seed/awards/250/200", route: "/awards", icon: <FaTrophy /> },
    { title: "Travel & Exploration", imgSrc: "https://picsum.photos/seed/travel/250/200", icon: <FaMountain />, route: "/travel" },
